      ...
      <div className="px-8 py-6">
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-indigo-50 rounded-2xl p-5">
            <p className="text-xs font-bold text-indigo-400 uppercase tracking-wider mb-3">Due Date</p>
            <p className="font-bold text-gray-900 text-lg">{formatDateShort(inv?.due_date)}</p>
            <p className="text-sm text-gray-500 mt-1">Issue: {formatDateShort(inv?.issue_date)}</p>
          </div>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-900 text-white">
                <th className="py-4 px-6 text-left text-sm font-bold">Service Description</th>
                <th className="py-4 px-4 text-center text-sm font-bold w-20">Qty</th>
                <th className="py-4 px-4 text-right text-sm font-bold w-28">Rate</th>
                <th className="py-4 px-6 text-right text-sm font-bold w-32">Amount</th>
              </tr>
            </thead>
            <tbody>
