      ...
      <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 p-8 text-white">
        <div className="flex justify-between items-start">
          ...
          <div className="text-right">
            <h2 className="text-4xl font-black tracking-tight mb-2">INVOICE</h2>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b-2 border-gray-900">
              <th className="py-3 text-left text-sm font-bold text-gray-900">Description</th>
              <th className="py-3 text-center text-sm font-bold text-gray-900 w-16">Qty</th>
              <th className="py-3 text-right text-sm font-bold text-gray-900 w-28">Price</th>
              <th className="py-3 text-right text-sm font-bold text-gray-900 w-28">Total</th>
            </tr>
          </thead>
